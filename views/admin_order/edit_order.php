		...
		<main class="mdl-layout__content mdl-color--grey-100">
			<div class="mdl-grid demo-content">
				<div class='container'>
					...
					<p class='error'>クレジット決済にかかる決済方法や金額の変更があった場合、必ずGMO　PAYMENT GETWAYの処理も忘れずに行ってください。</P>
					<?php endif; ?>
					...
					<table>
						...
						<tr>
							...
							<td></td><td><a href='<?php echo site_url('admin_order/list_order') ?>' class='edit_back'>戻る</a></td>
						</tr>
					</table>
					</form>
					<?php else: ?>
