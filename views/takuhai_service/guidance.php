	...
	<div class='content'>
		...
		<div class='content-inner'>
			...
			<div class='inner cart-back'>
				...
				<p class='note_one'>新規に会員登録をご希望される方は、<a class='edit' href='<?php echo site_url('area/check_area/nav') ?>'>新規会員登録</a>より必要事項を入力してください。</p>
				<p class='note_one'>会員登録されなくてもご利用いただけます。</p>
				<p><a class='new-window' target='blank' href='<?php echo site_url('customer/show_policy') ?>'>利用規約を確認する。</a></p>
			</div>
			<div class='inner member-back'>
				...
				<p><a class='new-window' target='blank' href='<?php echo site_url('area/search_area') ?>'>宅配サービス配達可能エリアを確認する</a></p>
			...
			<div class='inner takuhai-back'>
				<h3>配送・配送料金について</h3>
				<p class='note_one'>宅配スーパー健康屋では宅急便での配送のほかに、宅配スーパー健康屋スタッフがお客様のご自宅に商品を配達する宅配サービスを行っています。</p>
				<p><a class='new-window' target='blank' href='<?php echo site_url('index/show_charge') ?>'>配送料金について詳しく確認する</a></p>
			</div>
			<div class='inner payment-back'>
				<h3>お支払方法について</h3>
				<p><a class='new-window' target='blank' href='<?php echo site_url('question/detail/1')?>'>お支払方法について詳しく確認する。</a></p>
			</div>
			<div class='inner mail-back'>
				<h3>お問い合わせ</h3>
				<p class='note_one'>お電話：　0120-383-333　よりお問い合わせいただくか、<a class='edit' href='<?php echo site_url('contact/contact') ?>'>メールフォーム</a>よりお問い合わせください</p>
				<p><a class='new-window' target='blank' href='<?php echo site_url('question') ?>'>よくある質問を確認する</a></p>
			</div>
		</div>
	</div>
</div>
