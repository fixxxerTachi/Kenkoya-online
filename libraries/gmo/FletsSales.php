...
if( isset( $_POST['submit'] ) ){
	require_once( 'com/gmo_pg/client/input/FletsSalesInput.php');
	require_once( 'com/gmo_pg/client/tran/FletsSales.php');
	
	//入力パラメータクラスをインスタンス化します
	$input = new FletsSalesInput();/* @var $input FletsSalesInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new FletsSales();/* @var $exec FletsSales */
	
	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output FletsSalesOutput */
...
//FletsSales入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/FletsSales.php' );