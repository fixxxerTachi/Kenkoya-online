...
<div id="header">
	<h1>フレッツ登録・決済実行/モジュールタイプ(PHP) 呼び出しサンプル</h1>
	...
	<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
		<table>
			...
			<tr>
				...
				<td><input name="CenterCode" type="text" size="27" tabindex="22" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input name="ErrorRcvURL" type="text" size="27" tabindex="24" /></td>
			</tr>
			<tr>
				<th scope="row">商品ID(ItemId)</th>
				<td><input name="ItemId" type="text" size="27" tabindex="25" /></td>
			</tr>
			<tr>
				<th scope="row">商品名(ItemName)</th>
				<td><input name="ItemName" type="text" size="27" tabindex="26" /></td>
			</tr>
			<tr>
