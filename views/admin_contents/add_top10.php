	...
	<?php include __DIR__ . '/../templates/header.php' ?>
		<main class="mdl-layout__content mdl-color--grey-100">
			<div class="mdl-grid demo-content">
				<div class='contents'>
				<h2><span class='logo_pink'>Top10</span> <?php echo $h2title ?></h2>
				...
				-->
							...
							<tr>
								...
								<tr>
									...
									<td><input type='submit' name='submit' value='登録する' style='margin-right: 30px'><a class='edit_back' href='<?php echo site_url('admin_contents/add_top10') ?>'>戻る</a></td>
								</tr>
						</table>
					</form>
				</div>
				<div id="container">
					<h2><span class='logo_pink'>Top10</span> 売れ筋商品リスト</h2>
