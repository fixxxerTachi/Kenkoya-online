		...
		<h2><?php echo $h2title ?></h2>
			...
			<?php if($type == 'address'):?>
				...
				<?php else:?>
					<tr>
						<th><label for='zipcode'>郵便番号</label></th>
						<td><input type='text' name='zipcode1' id='zipcode1' value='<?php echo $form_data->zipcode1 ?>' size='3' maxlength='3'>-<input type='text' name='zipcode2' id='zipcode2' value='<?php echo $form_data->zipcode2 ?>' size='4' maxlength='4'> <a id='search_zip'>郵便番号で住所検索</a></td>
					</tr>
					<tr>
