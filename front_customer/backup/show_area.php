...
<?php foreach($cities as $city):?>
			<a href='<?php echo base_url("front_customer/show_area/{$area_id}/{$city->city}")?>'><?php echo $city->city ?></a>
<?php endforeach;?>
		</p>
		</div>
<?php if(!empty($result)):?>
		...
		<?php foreach($kana as $key => $value):?>
			<div id='area_content' class='clearfix'> 
				...
				<?php foreach($value as $v):?>
						...
						<ul>
						<?php if(!empty($lists)):?>
							<li class='kana'><a href='<?php echo base_url("front_customer/result_area/{$list->zipcode}") ?>'><?php echo $list->furigana_area ?></a></li>
							<li class='address'><a href='<?php echo base_url("front_customer/result_area/{$list->zipcode}") ?>'><?php echo $list->address ?></a></li>
						<?php endif;?>
						</ul>
						<?php endforeach;?>
				<?php endforeach;?>
