...
<div id="container">
	...
	<?php if($is_area): ?>
				<span style='color:orange'>○</span> 無料配達可能エリアです。 (配達コース：　<?php echo $result->takuhai_day ?>)
	<?php else:?>
			無料配達の対象エリア外ですが、宅配便での発送を承ります。
	<?php endif;?>
			</p>
	...
	<?php else:?>
			<p class='notice'>お客さまのご住所では健康屋宅配サービスをご利用いただけませんが、宅配便でご希望の商品を発送致します。</p>
	<?php endif;?>
		</div>
		<div class='content'>
			<p><a class='kiyaku' href='<?php echo base_url('front_customer/show_policy/nav')?>'>会員登録を進める（会員規約表示)</a></p>
