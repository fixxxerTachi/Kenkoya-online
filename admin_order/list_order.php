...
<?php include __DIR__ . '/../templates/side.php' ?>
	<div id="body">
		<div class='contents'>
				...
				<tr><th>受注日</th><td><label for='start_date'>開始</label><input type='text' name='start_date' id='start_date' value='<?php echo $form_data->start_date ?>'></td><th style='background: #fff'>~</th><td><label for='end_date'>終了</label><input type='text' name='end_date' id='end_date' value='<?php echo $form_data->end_date ?>'></td></tr>
				<tr><th>配達予定日</th><td><label for='deliver_start_date'>開始</label><input type='text' name='deliver_start_date' id='deliver_start_date' value='<?php echo $form_data->deliver_start_date ?>'></td><th style='background: #fff'>~</th><td><label for='deliver_end_date'>終了</label><input type='text' name='deliver_end_date' id='deliver_end_date' value='<?php echo $form_data->deliver_end_date ?>'></td></tr>
				<tr><th>受付状態</th><td>
				...
				<tr><td></td><td><input type='submit' name='submit' value='検索'></td></tr>
				</table>
				</form>
				<?php if($result): ?>
				<p>売上高:<?php echo number_format($total_price) ?>円</p>
					<table  class='list'>
						<tr><th>注文番号</th><th>受注日</th><th>店舗</th><th>お客様コード</th><th>お名前</th><th>住所</th><th>コース名</th><th>配達日</th><th>配達時間</th></tr>
...
<script>
$('#start_date , #deliver_start_date').datepicker({dateFormat:'yy/mm/dd'});
$('#end_date , #deliver_end_date').datepicker({dateFormat:'yy/mm/dd'});
</script>
</html>