...
<?php include __DIR__ . '/../templates/side.php' ?>
	...
	<?php if(isset($edit_flag)):?>
						<td><input type='submit' name='edit_submit' value='更新する'><a class='edit_back' href='<?php echo site_url('admin_admin/add_box') ?>'>戻る</a></td>
	<?php else:?>
						<td><input type='submit' name='submit' value='登録する'><a class='edit_back' href='<?php echo site_url('admin_admin/add_box') ?>'>戻る</a></td>
	<?php endif;?>
					</tr>
				</table>
			</form>
