...
if( isset( $_POST['submit'] ) ){
	require_once( 'com/gmo_pg/client/input/FletsCancelInput.php');
	require_once( 'com/gmo_pg/client/tran/FletsCancel.php');
	
	//入力パラメータクラスをインスタンス化します
	$input = new FletsCancelInput();/* @var $input FletsCancelInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new FletsCancel();/* @var $exec FletsCancel */
	
	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output FletsCancelOutput */
...
//FletsCancel入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/FletsCancel.php' );