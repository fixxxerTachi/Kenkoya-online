...
if( isset( $_POST['submit'] ) ){
	...
	$input = new EntryTranFletsInput();/* @var $input EntryTranFletsInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new EntryTranFlets();/* @var $exec EntryTranFlets */
	
	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output EntryTranFletsOutput */
...
//EntryTranFlets入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/EntryTranFlets.php' );