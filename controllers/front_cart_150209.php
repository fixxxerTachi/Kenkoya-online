...
//echo '<br>';
//var_dump($this->session->userdata('order_info'));
		...
		if(!empty($carts)){
			...
			*/
			//$this->session->set_userdata('order_price',$order);
...
/*
	public function test_mail()
	{
		$customer = array(
			'name'=>'堀池学',
			'address1'=>'新潟県柏市',
			'email'=>'akatome.k.tachibana@gmail.com',
		);
		$customer = (object)$customer;
		
		$send_address = $this->Mail_template->send_address;
		$mail_template = $this->Mail_template->get_by_id(ORDER_TEMPLATE);
