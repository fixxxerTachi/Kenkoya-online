...
if( isset($_POST['submit'])) {
	...
	require_once( 'com/gmo_pg/client/input/FletsStartInput.php');
	require_once( 'com/gmo_pg/client/common/RedirectUtil.php');
	$redirectInput = new FletsStartInput();
	...
	print ($redirectShow->fletsStart( FLETS_START_RIDIRECT_HTML , $redirectInput ) );
	exit();
}

//FletsStart入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/FletsStart.php' );
