				...
				<table id='menu'>
					<tr>
						...
						<td>
							<ul>
							<?php if($type=='address'):?>
								<li><a class='edit_menu' href='<?php echo site_url("front_customer/check_area/mypage")?>'>住所を変更する</a></li>
							<?php else:?>
								<li><a class='edit_menu' href='<?php echo site_url("front_customer/mypage_change/{$type}")?>'>変更する</a></li>
							<?php endif;?>
