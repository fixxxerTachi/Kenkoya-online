...
<head>
	...
	<title>[FletsCancel]-PGマルチペイメントサービス−モジュールタイプ呼び出しサンプル</title>
</head>
<body>

<div id="header">
	<h1>フレッツキャンセル/モジュールタイプ(PHP) 呼び出しサンプル</h1>
	...
	?>
		<table>
			...
			<tbody>
				...
				<tr>
					<th scope="row">センター処理日時(CenterExecTime)</th>
					<td><?php echo $output->getCenterExecTime() ?></td>
				</tr>
				<tr>
