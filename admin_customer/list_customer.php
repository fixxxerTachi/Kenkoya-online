...
<?php include __DIR__ . '/../templates/side.php' ?>
	<div id="body">
		<div class='contents'>
				...
				<form method='post'>
				<table class='detail'>
					<tr><th><label for='shop_code'>店舗</label></th><td><?php echo form_dropdown('shop_code',$shops,$selected) ?></td></tr>
				...
				<?php if($result): ?>
					...
					<table class='list'>
						<tr><th>店舗</th><th>配達地域</th><th>お客様番号</th><th>名前</th><th colspan='2'>住所</th><th>ポイント</th><th>ランク</th><th></th><th></th></tr>
