...
<?php if(isset($is_area)):?>
	...
	<?php /* 配達エリア外のリンク表示 */ else: ?>
					<tr>
						...
						<td><span>お客様のご住所では健康屋宅配サービスをご利用いただけませんが、宅配便でご希望の商品を配送いたします。<td>
	<?php endif;?>

					</tr>
					<tr>
						<td class='no-border'></td>
						<td><a class='kiyaku' href='<?php echo base_url($member_link->member_url) ?>'><?php echo $member_link->member_text ?></td>
					</tr><tr>
						<td class='no-border'></td>
						<td><a class='kiyaku' href='<?php echo base_url($member_link->url) ?>'><?php echo $member_link->text ?></td>
					</tr>
<?php endif;?>
				</table>
			</form>
